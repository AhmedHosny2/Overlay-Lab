...
namespace Portal.DeploymentService.Interface
{
    public interface IDeploymentService
    {
        ...
        public Task<ServerInstance> FetchContainerDetails(DockerClient client, string exerciseName, List<string> DisplayFields, string Uid);
        ...
        public Task RemoveUserOrStopContainer(DockerClient client, string ContainerId,string Uid);
    }
}